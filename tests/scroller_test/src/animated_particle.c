...
add_particle_animation( struct particle_t *p ) {
  ...
  case 0:
    p->animation = Stds_AddAnimation( "tests/scroller_test/res/img/particle/red/frame_", 2, animation_time );
    break;
  case 1:
    p->animation = Stds_AddAnimation( "tests/scroller_test/res/img/particle/green/frame_", 2, animation_time );
    break;
  case 2:
    p->animation = Stds_AddAnimation( "tests/scroller_test/res/img/particle/blue/frame_", 2, animation_time );
    break;
  default:
    break;
  }
